...
export function Specialists() {
  ...
  return (
    <>
      <GenericList title="Especialistas" description="Miembros del equipo NOVA." items={items} isLoading={isLoading} columns={['Especialista', 'Especialidad', 'Estado', 'Acciones']} onNew={() => { setEditing(null); setPhotoUrl(""); setActive(true); setOpen(true); }} renderRow={(item: any) => (
        <tr key={item.id} className="hover:bg-[#F2F2EF]/50 transition-colors">
          <td className="p-4 flex gap-4 items-center">
