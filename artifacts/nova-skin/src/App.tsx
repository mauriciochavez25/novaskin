...
const media = '/media/';
const fallback = {
  clinicName: 'NOVA SKIN', tagline: 'Estética avanzada, bienestar real', phone: '+1 (786) 555 0198',
  whatsapp: '+17865550198', email: 'hola@novaskinmedspa.com', address: '7800 SW 57th Avenue, Miami, FL',
  hours: 'Lun–Vie 9:00–19:00 · Sáb 9:00–15:00', instagram: '@novaskinmedspa', facebook: 'NOVA Skin Med Spa', tiktok: '@novaskinmedspa',
...
const localVideos = [
  [`${media}WhatsApp_Video_2026-08-28_at_11.57.22_AM_1787940023775.mp4`, `${media}WhatsApp_Video_2026-08-28_at_11.57.22_AM_1787940023775.jpg`],
  [`${media}WhatsApp_Video_2026-08-28_at_11.57.24_AM_1787940010694.mp4`, `${media}WhatsApp_Video_2026-08-28_at_11.57.24_AM_1787940010694.jpg`],
