...
function PublicSite() {
  ...
  return <div className="nova-grain overflow-hidden bg-[#F2F2EF] text-[#2F4055]">
    ...
    <main>
       ...
       <TeamSection specialists={specialistsFromApi} fallbackImages={[localImages[2], localImages[1]]} imageOverrides={[`${media}specialist-indira.png`, `${media}specialist-maria.png`]} onBook={scrollToContact} whatsappHref={salonWhatsAppHref} />
